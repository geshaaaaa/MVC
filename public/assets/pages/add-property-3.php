...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/add_property_step3.css">
...
<?php endif; ?>
    ...
    <form action="/add-property-step3" method="post">
        <div class="content">
            <h2>Локація та опис об'єкта</h2>
            ...
            <div class="form-group">
                <label for="description">Опис об'єкта:</label>
                <textarea name="description" id="description"></textarea>
            </div>
            <div class="form-group">
                <label for="guests_capacity_max">Максимальна кількість гостей:</label>
                <div class="guests-counter">
                    <button type="button" class="guests-counter-button" data-action="decrease">-</button>
                    <input type="text" name="guests_capacity_max" id="guests_capacity_max" value="0" min="0">
                    <button type="button" class="guests-counter-button" data-action="increase">+</button>
                </div>
            </div>
    ...
    <script src="/assets/js/add_property3.js"></script>
