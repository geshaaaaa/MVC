...
<main>
    <div class="container">
                ...
                <div class="filter-header">
                    ...
                    if ($hasFilters):
                        foreach ($filters as $key => $values):
                            ...
                            <a href="/removePropertyFilter?filter=<?= $key ?>&value=<?= urlencode($value) ?>" class="remove-filter">✕</a>
                        </span>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <?php if (!empty($values)): ?>
                            ...
                            <a href="/removePropertyFilter?filter=<?= $key ?>" class="remove-filter">✕</a>
                        </span>
                                <?php endif; ?>
                            <?php endif; ?>
                        <?php endforeach; ?>
        ...
        <div class="filter-modal">
            <form action="api/properties-filter" method="get">
        ...
        <div class="content">
            <div class="property-list">
                <?php
                $properties = $_SESSION['all_properties'] ?? [];
                if ($properties):
                    foreach ($properties as $housing):
